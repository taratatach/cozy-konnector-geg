How to contribute to Cozy Generali Konnector?
=============================================
...
- What is the version of the Cozy Generali Konnector?
...
```
$ git clone github.com/carrieje/cozy-konnector-generali.git
$ cd cozy-konnector-generali
$ git remote add fork git://github.com/yourusername/cozy-konnector-generali.git
```
...
Go to https://github.com/yourusername/cozy-konnector-generali and select your branch. Click the 'Pull Request' button and fill out the form.
...
[issues]: https://github.com/carrieje/cozy-konnector-generali/issues/new
