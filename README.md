[Cozy][cozy] GEG Konnector
==========================

:warning: Disclaimer
--------------------

This repository is in an unstable state.
Development have been started from Generali Konnector repository and contains
most of its documentation untouched.
For instance, this README does not reflect GEG Konnector's documentation.

The konnector does not work yet.

Be aware of These two important notes while browsing and using this konnector.
